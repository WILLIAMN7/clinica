                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <select class="form-control" id="grupoEtario" name="grupoEtario" required>
                                                    ...
                                                    <option value="Menor de 1 año" <?php if ("Menor de 1 año" == set_value('grupoEtario')) {
                                                                                        echo 'selected';
                                                                                    } ?>>Menor de 1 año</option>
                                                    <option value="1-4 años" <?php if ("1-4 años" == set_value('grupoEtario')) {
                                                                                    echo 'selected';
                                                                                } ?>>1-4 años</option>
                                                    <option value="5-9 años programado" <?php if ("5-9 años programado" == set_value('grupoEtario')) {
                                                                                            echo 'selected';
                                                                                        } ?>>5-9 años programado</option>
                                                    <option value="5-14 años no programado" <?php if ("5-14 años no programado" == set_value('grupoEtario')) {
                                                                                                echo 'selected';
                                                                                            } ?>>5-14 años no programado</option>
                                                    <option value="10-14 años programado" <?php if ("10-14 años programado" == set_value('grupoEtario')) {
                                                                                                echo 'selected';
                                                                                            } ?>>10-14 años programado</option>
                                                    <option value="15-19 años" <?php if ("15-19 años" == set_value('grupoEtario')) {
                                                                                    echo 'selected';
                                                                                } ?>>15-19 años</option>
                                                    <option value="Mayor de 20 años" <?php if ("Mayor de 20 años" == set_value('grupoEtario')) {
                                                                                            echo 'selected';
                                                                                        } ?>>Mayor de 20 años</option>
                                                    <option value="Embarazada" <?php if ("Embarazada" == set_value('grupoEtario')) {
                                                                                    echo 'selected';
                                                                                } ?>>Embarazada</option>
                                                </select>
                                            </div>
