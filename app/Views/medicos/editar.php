                                ...
                                <div class=form-group>
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input class="form-control" id="fechaNacimiento" name="fechaNacimiento" type="date" value="<?php echo $datos['fechanacimientoMedico'];?>" autofocus required>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <select class="form-control" id="genero" name="genero" required>
                                                <option value="" <?php if(""==$datos['generoMedico']){ echo 'selected';}?>>Seleccionar género</option>
                                                <option value="M" <?php if("M"==$datos['generoMedico']){ echo 'selected';}?>>Masculino</option>
                                                <option value="F" <?php if("F"==$datos['generoMedico']){ echo 'selected';}?>>Femenino</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
