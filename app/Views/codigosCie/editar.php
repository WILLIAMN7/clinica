                        ...
                        <div class=form-group>
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" id="codigo_cie" name="codigo_cie" type="text" value="<?php echo $datos['codigoCodigosCie']; ?>" autofocus required>
                                </div>
                                <div class="col-12 col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <select class="form-control" id="tipo" name="tipo" required>
                                        <option value="" <?php if(""==$datos['tipoCodigosCie']){ echo 'selected';}?>>Seleccionar</option>
                                        <option value="DIA" <?php if("DIA"==$datos['tipoCodigosCie']){ echo 'selected';}?>>Diagnostico</option>
                                        <option value="TRA" <?php if("TRA"==$datos['tipoCodigosCie']){ echo 'selected';}?>>Tratamiento</option>
                                    </select>
                                </div>
                            </div>
                        </div>
