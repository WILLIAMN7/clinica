                            ...
                            <div class="row">
                                <div class="col-4 col-sm-4">
                                    ...
                                    ?>
                                            ...
                                            <input type="checkbox" value="<?php echo $permiso['idPermisos'] ?>" name="permisos[]" <?php if (isset($asignado[$permiso['idPermisos']])) {
                                                                                                                                        echo 'checked';
                                                                                                                                    } ?> /> <label><?php echo $permiso['nombrePermisos'] ?></label>
                                            <br />
                                    <?php
                                        }
                                    }
