                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                ...
                                <select class="mi-selector form-control" id="diagnostico" name="diagnostico" required>
                                    ...
                                    <?php foreach ($codigosCie as $codigoCie) { ?>
                                        <option value="<?php echo $codigoCie['idCodigosCie'] ?>" <?php if ($codigoCie['idCodigosCie'] == $diagnosticos['idCodigosCie']) {
                                                                                                    echo 'selected';
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <select class="mi-selector form-control" id="tipoDiagnostico" name="tipoDiagnostico" required>
                                    <option value="" <?php if ("" == $diagnosticos['tipoDiagnostico']) {
                                                            echo 'selected';
                                                        } ?>>Seleccionar</option>
                                    <option value="PRE" <?php if ("PRE" == $diagnosticos['tipoDiagnostico']) {
                                                            echo 'selected';
                                                        } ?>>Presuntivo</option>
                                    <option value="DEF" <?php if ("DEF" == $diagnosticos['tipoDiagnostico']) {
                                                            echo 'selected';
                                                        } ?>>Definitivo</option>
                                </select>
                            </div>
