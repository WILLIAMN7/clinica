        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="panel">
                <div class="embed-responsive embed-responsive-4by3" style="margin-top: 30px;">
                    <iframe id="youriframe" style="width: 100%; height:100%; min-height:500px" class="embed-responsive-item" src="" title="pacientes"></iframe>
                </div>
            </div>
        </div>
    </div>
            ...
            if (fechaInicio < fechaFinal) {
                $.ajax({
                    ...
                    success: function(data) {
                        document.getElementById('youriframe').src = baseurl + "/pacientes/generaPacientesPdf/" + fechaInicio + '/' + fechaFinal;
                    }
                });
            } else {
